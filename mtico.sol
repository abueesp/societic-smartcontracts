...
contract MyToken is StandardToken, SafeMath {
    ...
    function MyToken(address _icoContract) {
...
contract MyTokenIco is SafeMath {
    /*
     * ICO meta data
     */
    MyToken public cartaxiToken;
    ...
    function MyTokenIco(address _icoManager, address _preIcoToken) {
        assert(_preIcoToken != 0x0);
        assert(_icoManager != 0x0);

        cartaxiToken = new MyToken(this);
